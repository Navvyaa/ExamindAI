...
export default function Uploadscreen() {
    ...
    return (
        <div><header className="my-8 w-full mx-auto">
            <p className="mb-2 text-center lg:text-4xl font-bold capitalize ">
                Upload <span className="bg-orange-100 px-4 text-orange-500 rounded-lg py-1">question paper & answer sheet </span>
            </p>
            <p className="text-lg font-medium my-4 text-center ">Upload both files to get started</p>
            ...
            <div className="grid gap-6 md:grid-cols-2 rounded-xl bg-neutral-100 p-4" >
                <UploadCard
